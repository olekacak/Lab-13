...
public class ClientTextFrame extends JFrame {
	...
	private JLabel lblCalcTotalWord;
	...
	/**
	 * This method update the value of total word count on the frame
	 * 
	 * @param serverDate: Server's date
	 */
	public void updateTotalWord(String totalWord) {
		SwingUtilities.invokeLater(() -> {
		this.lblCalcTotalWord.setText(totalWord);
		});
	}
	...
	private JPanel getServerDatePanel(Font font) {
		...
		lblCalcTotalWord.setFont(font);
		lblDate.setBackground(Color.WHITE);
		lblDate.setOpaque(true);
		lblCalcTotalWord.setBackground(Color.WHITE);
		lblCalcTotalWord.setOpaque(true);

		// Organize components into panel
		panel.add(lblDate);
		panel.add(lblCalcTotalWord);
